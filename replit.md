...
- June 28, 2025: Updated Add Entity modal to use centralized field definitions
  - Replaced hard-coded labels with centralized fieldDefinitions for user_name and user_email fields
  ...
  - Modal now dynamically pulls field properties from centralized configuration system
